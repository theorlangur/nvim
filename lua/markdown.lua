...
function MarkupMappings(args)
    ...
    vim.api.nvim_command([[
        ...
        let pandoc_cmd = '!pandoc --from=gfm --to=pdf --resource-path=' . shellescape(g:nvim_config_path) . '/pandoc --template=github-style.tex --pdf-engine=xelatex --syntax-highlight=tango -o %:r.pdf %'
        if <q-args> != ''
